 ...
 * If you need to perform changes, edit the CessionDao class instead!
 */
...
/**
 * The AbstractCessionDao class will maintain the persistence of Cession class into
 * the cession table.
 */
abstract class AbstractCessionDao
{
    ...
    /**
     * Persist the Cession instance.
     *
     * @param Cession $obj The bean to save.
     */
    public function save(\App\Model\Cession $obj) : void
    {
        $this->tdbmService->save($obj);
    }

    /**
     * Get all Cession records.
     *
     * @return \App\Model\Cession[]|\TheCodingMachine\TDBM\ResultIterator
     */
    public function findAll() : \TheCodingMachine\TDBM\ResultIterator
    {
        if ($this->defaultSort) {
            $orderBy = 'cession.'.$this->defaultSort.' '.$this->defaultDirection;
        } else {
            $orderBy = null;
        }
        return $this->tdbmService->findObjects('cession', null, [], $orderBy);
    }

    /**
     * Get Cession specified by its ID (its primary key).
     *
     * If the primary key does not exist, an exception is thrown.
     *
     * @param string $id
     * @param bool $lazyLoading If set to true, the object will not be loaded right away. Instead, it will be loaded when you first try to access a method of the object.
     * @return \App\Model\Cession
     ...
     */
    public function getById(string $id, bool $lazyLoading = false) : \App\Model\Cession
    {
        return $this->tdbmService->findObjectByPk('cession', ['id' => $id], [], $lazyLoading);
    }

    /**
     * Get all Cession records.
     *
     * @param \App\Model\Cession $obj The object to delete
     * @param bool $cascade If true, it will delete all objects linked to $obj
     */
    public function delete(\App\Model\Cession $obj, bool $cascade = false) : void
    {
        if ($cascade === true) {
    ...
    protected function find($filter = null, array $parameters = [], $orderBy = null, array $additionalTablesFetch = [], ?int $mode = null) : \TheCodingMachine\TDBM\ResultIterator
    {
        ...
        return $this->tdbmService->findObjects('cession', $filter, $parameters, $orderBy, $additionalTablesFetch, $mode);
    }

    /**
     * Get a list of Cession specified by its filters.
     *
    ...
    protected function findFromSql(string $from, $filter = null, array $parameters = [], $orderBy = null, array $additionalTablesFetch = [], ?int $mode = null) : \TheCodingMachine\TDBM\ResultIterator
    {
        ...
        return $this->tdbmService->findObjectsFromSql('cession', $from, $filter, $parameters, $orderBy, $mode);
    }

    /**
     * Get a list of Cession from a SQL query.
     *
    ...
    {
        return $this->tdbmService->findObjectsFromRawSql('cession', $sql, $parameters, $mode, null, $countSql);
    }

    /**
     * Get a single Cession specified by its filters.
     *
     * @param mixed $filter The filter bag (see TDBMService::findObjects for complete description)
     * @param mixed[] $parameters The parameters associated with the filter
     * @param string[] $additionalTablesFetch A list of additional tables to fetch (for performance improvement)
     * @return \App\Model\Cession|null
     */
    protected function findOne($filter = null, array $parameters = [], array $additionalTablesFetch = []) : ?\App\Model\Cession
    {
        return $this->tdbmService->findObject('cession', $filter, $parameters, $additionalTablesFetch);
    }
     ...
     * @return \App\Model\Cession|null
     */
    protected function findOneFromSql(string $from, $filter = null, array $parameters = []) : ?\App\Model\Cession
    {
        return $this->tdbmService->findObjectFromSql('cession', $from, $filter, $parameters);
    }
