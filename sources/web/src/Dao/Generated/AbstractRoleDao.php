...
/**
 * The AbstractRoleDao class will maintain the persistence of Role class into the
 * roles table.
 */
abstract class AbstractRoleDao
{
     ...
     */
    public function save(\App\Model\Role $obj) : void
    {
     ...
     *
     * @return \App\Model\Role[]|\TheCodingMachine\TDBM\ResultIterator
     */
     ...
     */
    public function getById(string $id, bool $lazyLoading = false) : \App\Model\Role
    {
     ...
     * Get all Role records.
     *
     * @param \App\Model\Role $obj The object to delete
     * @param bool $cascade If true, it will delete all objects linked to $obj
     */
    public function delete(\App\Model\Role $obj, bool $cascade = false) : void
    {
        if ($cascade === true) {
     ...
     */
    protected function findOne($filter = null, array $parameters = [], array $additionalTablesFetch = []) : ?\App\Model\Role
    {
     ...
     * @return \App\Model\Role|null
     */
    protected function findOneFromSql(string $from, $filter = null, array $parameters = []) : ?\App\Model\Role
    {
    ...
    /**
     * Get a Role filtered by nom.
     *
     * @param string $nom
     * @param string[] $additionalTablesFetch A list of additional tables to fetch (for performance improvement)
     * @return \App\Model\Role|null
     */
    public function findOneByNom(string $nom, array $additionalTablesFetch = []) : ?\App\Model\Role
    {
        $filter = [
                    'nom' => $nom,
                ];
