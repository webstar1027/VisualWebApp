 ...
 */
final class Version20190825211134 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $table = $db->table('frais_structures_periodique');
        $table
            ->column('frais_structures_id')->references('frais_structures')->graphqlField()
